...
class ChatAssistant:
    ...
    def _route_with_llm(self, text: str) -> dict | None:
        system_prompt = (
            ...
            "intent in [welcome, calendar_add, add_task, plan_day, suggest_free, weekly_report, sync, calendar_check, current_focus, "
            ...
            "Use welcome ONLY when user explicitly sends /start. "
            "Use current_focus when user asks what they should do right now / at this moment. "
